			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-7">
					<div class="section-title">
						<p class="text-primary text-uppercase fw-bold mb-3">About LostVote</p>
						<h2 class="h1 mb-4">Assured Voting Portal</h2>
						<div class="content pe-0 pe-lg-5">
							<p> 
								E-voting systems are becoming popular with the widespread use of computers and
								embedded systems. Security is the vital issue should be considered in such systems.
							</p>
							<p>
								This LostVote a new e-voting portal that fulfills the security requirements of e-
								voting. The proposed system is implemented on web which serves as a voting machine. It is
								especially for companies who used to take vote for a particular positioning in company.
								Employees have to visit the company voting booth to cast their vote in the present system. This
								system is online and hence even people who live out of their home town can also vote.
							</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 mt-5 mt-lg-0">
					<img loading="lazy" decoding="async" src="images/banner/about-us-page-banner.png" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-around">
				<div class="col-lg-5">
					<div class="section-title">
						...
						<h2>What is LostVote ?</h2>
					</div>
					<div class="content"><strong>“LostVote”</strong> provide a medium where an employee login as voter and can use his\her voting right
					online without any difficulty. This online voting portal is designed for specific company, so that
					employee of their company can choose a leader for precise position by express their choice. The
					main purpose for developing this Secure E-voting Portal is to make a voting process easier,
					portable and more secure compare to cast vote through the voting booth.</div>
				</div>
				<div class="col-lg-5">
					<div class="section-title">
						<p class="text-primary text-uppercase fw-bold mb-3"></p>
					...
					<div class="content">
						<ul>
							<li>The system can be used any time and from anywhere by the Voters.</li>
							<li>No one can cast votes on behalf of others and multiple times.</li>
							<li>This portal has clean and user-friendly interface. So, it’s improving voting with easy operationally system.</li>
							<li>Only the admin added persons can get their credentials and only they can be the part of this system and cast their votes which is the great aspects of security.</li>
						</ul>
					</div>
				</div>
			</div>
