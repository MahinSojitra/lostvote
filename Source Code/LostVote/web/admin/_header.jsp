        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="assets/img/user-image.jpg" alt="Profile" class="rounded-circle">
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="manage-voters">
                <i class="bi bi-people-fill"></i>
                <span>Manage Voters</span>
            </a>
        </li><!-- End Manage Voters Nav -->
        
        <li class="nav-item">
            <a class="nav-link collapsed" href="manage-candidates">
                <i class="bi bi-people-fill"></i>
                <span>Manage Candidates</span>
            </a>
        </li><!-- End Manage Candidates Nav -->
                
        <li class="nav-item">
            <a class="nav-link collapsed" href="manage-elections">
                <i class="bi bi-building-fill-gear"></i>
                <span>Manage Elections</span>
            </a>
        </li><!-- End Manage Elections Nav -->
        
        <li class="nav-item">
            <a class="nav-link collapsed" href="manage-reminders">
