...
<%@taglib prefix="email" uri="/WEB-INF/tlds/lostvote/email-senders/email" %>
                ...
                <div class="row">
                    <div class="col-8 mx-auto text-center">
                        ...
                        <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                            ...
                            <li class="list-inline-item">/ &nbsp; <a href="contact">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section class="section">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-10 shadow card rounded bg-white" id="contact-email-send">
                        <div class="p-5">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <c:if test="${param.contact_name!=null && param.contact_subject!=null && param.contact_email!=null && param.contact_message!=null}">
                                        <email:sendContactEmail contact_name="${param.contact_name}" contact_email="${param.contact_email}" 
                                                    contact_subject="${param.contact_subject}" contact_message="${param.contact_message}" />
                                        <%
                                    ...
                                    <div class="contact-form">
                                        <form action="contact#contact-email-send" method="post" name="contact_form">
                                            <div class="form-group mb-4 pb-2">
                                                <label for="exampleFormControlInput1" class="form-label">Full Name</label>
                                                <input type="text" class="form-control shadow-none" name="contact_name" id="contact_name" required="required">
                                            </div>
                                            <div class="form-group mb-4 pb-2">
                                                <label for="exampleFormControlInput1" class="form-label">Subject</label>
                                                <input type="text" class="form-control shadow-none" name="contact_subject" id="contact_subject" required="required">
                                            </div>
                                            <div class="form-group mb-4 pb-2">
                                                <label for="exampleFormControlInput1" class="form-label">Email address</label>
                                                <input type="email" class="form-control shadow-none" name="contact_email" id="contact_email" required="required">
                                            </div>
                                            <div class="form-group mb-4 pb-2">
                                                <label for="exampleFormControlTextarea1" class="form-label">Write Message</label>
                                                <textarea class="form-control shadow-none" name="contact_message" id="contact_message" required="required" rows="3"></textarea>
                                            </div>
                                            <button class="btn btn-primary w-100" id="btnSendMsg" type="submit">Send Message</button>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-info">
                                        <div class="block mt-0">
                                            ...
                                            <div class="content">Call Us We Will Be Happy To Help
                                                <br> <a href="tel:+919104851608">+91-910-485-608</a> 
                                                <br>Monday - Friday
                                                <br>9:00 AM TO 8:00 PM</div>
                                        </div>
                                        <div class="block mt-4">
                                            <h4 class="h5">Rajkot Office</h4>
                                            <div class="content">
                                                LostVote
                                                <br>
                                                "Yogidham Gurukul", Kalawad Road,
                                                <br>
